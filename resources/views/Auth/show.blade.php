...
<section class="max-w-3xl mx-auto">
    ...
    <div class="border border-light-gray/30 p-md rounded-md flex flex-col gap-sm md:max-w-3xl mx-auto ">
        ...
        <div class="text-center mt-md ">
            <a href="{{ route('auth.edit', auth()->user()->id) }}" class="bouton block sm:inline m-0"><i class="fa-solid fa-user-pen mr-2.5"></i>Modifier mon profil</a>
        </div>
    </div>
</section>

<!-- Modale pour supprimer le profil utilisateur-->
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl">
                    <div class="bg-white p-sm sm:p-md">
